...
var file_user_proto_goTypes = []any{
	...
	(*GetUserInfoByEmailRequest)(nil), // 2: user.GetUserInfoByEmailRequest
...
var file_user_proto_depIdxs = []int32{
	...
	2, // 3: user.UserService.GetUserInfoByEmail:input_type -> user.GetUserInfoByEmailRequest
	...
	3, // 7: user.UserService.GetUserInfoByEmail:output_type -> user.GetUserInfoResponse
